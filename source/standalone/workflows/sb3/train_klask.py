...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: dict):
    ...
    # TODO:
    # - which gamma?
    # - normalize observations? normalize goals?
    # - normalize rewards?
    if "normalize_input" in agent_cfg:
        env = VecNormalize(
            ...
            norm_obs_keys=["observation", "desired_goal", "achieved_goal"] if use_her else None,
    ...
    agent_kwargs = {}
    if "bootstrap" in agent_cfg:
        agent_kwargs["bootstrap"] = agent_cfg.pop("bootstrap")
    if "replay_buffer_class" in agent_cfg:
        agent_kwargs["replay_buffer_class"] = agent_cfg.pop("replay_buffer_class")
